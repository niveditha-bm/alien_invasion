...
class AlienInvasion:
    ...
    def __init__(self):
        """Iniialise the game, and create game resorces."""
        pygame.init()
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Get rid of any remaining aliend=s and bullets.
            self.aliens.empty()
            self.bullets.empty()
    ...
    def _update_bullets(self):
        ...
        self._check_bullet_action_collisions()

    def _check_bullet_action_collisions(self):
    ...
    def _update_aliens(self):
        ...
        Check if the fleet is at an edge,
         and update the positions of all aliens in a fleet
        """
    ...
    def _create_alien(self, alien_number, row_number):
        """Create an alien and place it ina  row"""
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
